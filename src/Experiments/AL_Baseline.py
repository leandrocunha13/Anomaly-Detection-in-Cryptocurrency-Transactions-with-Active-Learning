...
(train_data, test_data) = preprocessing_pipeline(last_train_timestep = 34, last_test_timestep = 49,
                                                         only_labeled = True)
al_baseline_rf = AL_experiment(runs = 1 , supervised_classifiers = supervised_classifier, warmup_policies = warmup_learner_dict, 
...
(train_data, test_data) = preprocessing_pipeline(last_train_timestep = 34, last_test_timestep = 49,
                                                         only_labeled = True)
al_baseline_xgb = AL_experiment(runs = 1 , supervised_classifiers = supervised_classifier, warmup_policies = warmup_learner_dict, 
                   hot_policies = hot_learner_dict, train_data = train_data, test_data = test_data, threshold = 60, 
                   batch_size=50, total_budget = 60, labeled_pool_sizes = [200,500,1000,1500,3000])
...
(train_data, test_data) = preprocessing_pipeline(last_train_timestep = 34, last_test_timestep = 49,
                                                         only_labeled = True)
al_baseline_lr = AL_experiment(runs = 1 , supervised_classifiers = supervised_classifier, warmup_policies = warmup_learner_dict, 
                   hot_policies = hot_learner_dict, train_data = train_data, test_data = test_data, threshold = 60, 
                   batch_size=50, total_budget = 60, labeled_pool_sizes = [200,500,1000,1500,3000])
